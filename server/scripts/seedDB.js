...
const songList = [
    ...
    },
    {
        ...
        "tags": "Folk, Dark, Narrative, Board Game, Arkham Horror, A Scary, Silly, Myth, Collab, Sci-Fi, HP Lovecraft, Ivory, Heather Peralto, Brendan Whalen, Jason Brown"
    },
    {
        "number": 150,
...
async function insertSongs(array) {
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        let date = formatter.format(new Date(array[i].date))
